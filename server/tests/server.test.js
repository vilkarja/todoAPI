...
describe('DELETE /todos/:id', () => {
    ...
    it('should not delete someone elses todo with wrong id', (done) => {
...
describe('POST /users/login', () => {
    it('should login existing user and return auth token', (done) => {
        request(app)
        .post('/users/login')
        .send({
            email: users[1].email,
...
describe('DELETE /users/me/token', () => {
    it('should delete existing auth token on logout', (done) => {
        request(app)
